...
#ifndef __LCMP_FIND_SCENE_H__
#define __LCMP_FIND_SCENE_H__
#include <cugl/cugl.h>
#include <vector>
 ...
 */
class FindScene : public cugl::Scene2 {
public:
//  MARK: - Enumerations
    
    /** The configuration status */
    enum Status {
        /** Player is waiting on a connection */
        IDLE,
        /** Player is waiting to be assigned to a room */
        WAIT,
        /** Player is waiting on all other players to join */
        HOST,
        /** Player is waiting for the host to start the game */
        CLIENT,
...
//  MARK: - Properties
    ...
    /** The current status */
    Status _status;
    /** The amount to wait before */
    float _requestCooldown = 0;
